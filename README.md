...
| 단계 | 내용 |
|---|---|
| 1단계 역량 프로필 | 진로적합성·탐구연속성·서사일관성·심화잠재력 0~100점 + 근거 서술 |
| 2단계 종합 진단 | 활동 요약·강점 3개·보완점 3개·추천 전공 3~5개 |
| 3단계 활동 추천 A | 안정형(기존 활동 연장) + 심화형(희망 전공 심층 탐구) |
| 4단계 활동 추천 B | 차별화형(독창적 문제의식) + 실천형(측정·실험·인터뷰 등) |
| 5단계 서사 설계 전략 | 학생부 서사 전략(430~470자) + 추가 탐구 아이디어 6개 |

- JSON 키 누락·파싱 실패 시 해당 단계만 자동 재시도 (최대 1회)
