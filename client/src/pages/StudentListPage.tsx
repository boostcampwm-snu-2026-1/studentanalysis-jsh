...
export default function StudentListPage() {
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-4 mb-8 bg-surface-container rounded-lg px-6 py-5">
        <select
          value={selectedGrade ?? ''}
          onChange={e => {
          ...
          className="text-sm text-on-surface bg-surface-container-lowest border border-outline-variant rounded px-4 py-2.5 outline-none focus:border-primary cursor-pointer min-w-28"
        >
